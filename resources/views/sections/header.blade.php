...
<header class="text-gray-400 bg-gray-900 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      <a class="mr-5 hover:text-white cursor-pointer" href="#suplmen">Data Suplemen</a>
      <a class="mr-5 hover:text-white cursor-pointer" href="#kriteria">Kriteria</a>
      <a class="mr-5 hover:text-white cursor-pointer" href="#saw">SAW</a>
      <a class="mr-5 hover:text-white cursor-pointer" href="#perangkingan">Hasil Perangkingan</a>
    </nav>
