    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="flex items-center justify-center h-24 rounded bg-gray-700 dark:bg-gray-800">
                <a href="/admin/kriteria/tambah" class="block w-8 text-center">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-2">{{ $k->key }}</td>
                            <td class="px-6 py-2">{{ $k->value }}</td>
                            <td class="px-6 py-2">{{ $k->keterangan }}</td>
                            <td class="px-6 py-2">{{ $k->bobot }}</td>
                            <td class="flex px-6 py-2.5 items-center justify-center">
                                <a class="inline-block border border-blue-500 rounded-md py-2 px-2 bg-blue-500 text-white mx-2" href="/kriteria/edit/{{ $k->id }}">
                                ...
                                <a data-id="{{ $k->id }}" class="delete inline-block border border-red-500 rounded py-2 px-2 bg-red-500 text-white" href="#">
    ...
    $(".delete").click(function() {
        ...
        Swal.fire({
            ...
            if (willDelete.isConfirmed) {
                ...
                window.location = "/kriteria/delete/" + itemId + "";
            }
        });
    });
</script>
