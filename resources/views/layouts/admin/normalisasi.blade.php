...
@section('page_title', 'Normalisasi | Admin')
@section('content')
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4">Harga (C1)</th>
                            <th scope="col" class="px-6 py-4">Jumlah/Berat (C2)</th>
                            <th scope="col" class="px-6 py-4">Vitamin A (C3)</th>
                            <th scope="col" class="px-6 py-4">Vitamin B (C4)</th>
                            <th scope="col" class="px-6 py-4">Vitamin C (C5)</th>
                        </tr>
                    </thead>
                    <tbody>
